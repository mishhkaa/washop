...
<div>
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Додати категорію</h1>
        <p class="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">Створіть нову категорію для товарів</p>
    </div>
    ...
    <div class="card max-w-2xl">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus placeholder="Введіть назву категорії">
            </div>
