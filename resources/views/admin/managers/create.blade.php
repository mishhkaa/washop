...
@section('title', 'Додати менеджера')

@section('content')
<div>
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Додати менеджера</h1>
        <p class="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">Створіть нового менеджера</p>
    </div>
