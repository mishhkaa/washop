...
@section('title', 'Розрахувати: ' . $manager->name)
...
<div>
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Розрахувати виплату</h1>
    ...
    <div class="card max-w-2xl">
        ...
        <form action="{{ route('admin.managers.payments.store', $manager) }}" method="POST">
            @csrf

            <div class="form-group">
                <label for="amount">Сума виплати (zł)</label>
                <input type="number" id="amount" name="amount" step="0.01" min="0" value="{{ old('amount') }}" required placeholder="0.00">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="notes" name="notes" rows="4" placeholder="Додаткові примітки про виплату">{{ old('notes') }}</textarea>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-4 flex-wrap mt-8 pt-6 border-t border-gray-200">
                ...
                <a href="{{ route('admin.managers.calculation', $manager) }}" class="btn-secondary flex-1 sm:flex-none text-center">
                    Скасувати
                </a>
            </div>
        </form>
